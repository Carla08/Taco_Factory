...
public class Tacos_Factory {
    ...
    int consumed=0;
    int chef_velocity;
    int maistro_velocity;
    JLabel cooked;
    JLabel eated;
    
        
    public void Change_Chef_velocity(int vel){
        chef_velocity=vel*45;
    }
    
    public void Change_Maistro_velocity(int vel){
    ...
    public void startTacosFactory(int chefVelocity, int maistroVelocity, JLabel cooked, JLabel eated){
        //y=-45x+5000
        //Lowest velocity 0=5000
        //Fastest velocity 100=500
        this.cooked=cooked;
        this.eated=eated;
        chef_velocity=(-45*chefVelocity+5000);
        maistro_velocity=(-45*maistroVelocity+5000);
    ...
    class Producer implements Runnable {
        ...
        public String produce(){
            ...
            cooked.setText(Integer.toString(produced));
            System.out.println("Chef velocity: "+chef_velocity);
            return producto;
        }
    ...
    class Consumer implements Runnable {
        ...
        public String take(){
            ...
            System.out.println("Maistro velocity:"+maistro_velocity);
            return producto;
        }
        ...
        public void consume(String producto){
            ...
            eated.setText(Integer.toString(consumed));
        }
    }
}
